    ...
    public function txt($envio = 0, $comprobante_id = '') {
        ...
        if ($envio == 0) {
            if ($comprobante['tipo_documento_id'] < 4) {
                ...
                $linea .= "{$comprobante['total_otros_cargos']}|";//sumatoria otros cargos
...
//            '',
    ...
    public function buscar_cliente(){
        ...
        $this->db->like('ruc',$texto,'after');
        $this->db->or_like('razon_social',$texto,'after');
    ...
    public function init_dashboard(){
        ...
        ////TOTAL CLIENTES
        $cli = $this->db->count_all('clientes'); 
        $response['d'] = $cli;
