...
<div class="container">
    <form>    
        <h2>Lista de Adelanto de Pedidos : <?php echo $empresa[0]['empresa']?></h2>
...
<div class="row" align="right" style="padding-right: 25%;">
    <br>
    <a href="<?PHP echo base_url(); ?>index.php/adelanto_pedido/nuevo/<?php echo $empresa['id']?>" class="btn btn-success">Nuevo Adelanto</a>
...
<script type="text/javascript">
    ...
    $('#exportarExcel').click(function(){
                ...
                var url = '<?PHP echo base_url() ?>index.php/adelanto_pedido/exportarExcel?cliente=' + cliente_id + '&fecha=' +  fecha + '&correlativo=' + correlativo;
    ...
    var dataSource = new kendo.data.DataSource({
             transport: {
                read: {
                    url:"<?php echo base_url()?>index.php/adelanto_pedido/getMainList/",
                    dataType:"json",
                    method:'post',
                    data:function(){
                        return {
    ...
    $("#grid").kendoGrid({
        ...
        dataBound:function(e){
            ...
            $(".btn-editar").click(function(e){
               ...
               location.href="<?php echo base_url()?>index.php/adelanto_pedido/editar/"+idNota;
            });

             $(".btn-eliminar").click(function(e){
               var idNota = $(this).data('id');
               if(confirm("¿Eliminar adelanto de pedido?")){
                location.href="<?php echo base_url()?>index.php/adelanto_pedido/eliminar_nota/"+idNota;
               }
    ...
    function detailInit(e) {
        ...
        detailRow.find(".lista_notas").kendoGrid({
            dataSource: {
                ...
                transport: {
                    read:{
                        url:"<?php echo base_url()?>index.php/adelanto_pedido/getMainListDetail/",
                        dataType:"json",
                        method:'post',
                        data:function(){
                            return {
