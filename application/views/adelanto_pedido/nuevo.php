...
<form id="formComprobante" class="form-horizontal" role="form" action="<?PHP echo base_url()?>index.php/notas/guardarNota" method="post" autocomplete="off">
    ...
    <div class="row">        
        <div class="col-md-12">
            <div style="text-align: center"><h3>ADELANTO DE PEDIDO - <b><?= $empresa[0]['empresa']?></b></h3></div>
...
<script type="text/javascript">        
    ...
    $('body').delegate('.descripcion-item', 'keydown', function() {
        $('.descripcion-item').autocomplete({
            source : '<?PHP echo base_url();?>index.php/adelanto_pedido/buscador_item',
            minLength : 2,
    ...
    $("#guardar").click(function(e){
       ...
       $("#descontar_stock").val(1);
            ...
            $.ajax({
                url:'<?PHP echo base_url()?>index.php/adelanto_pedido/guardarNota',
                method:'post',
                ...
                success:function(response){
                    ...
                    {
                        toast("success",1500,"Adelanto de pedido registrada");
                        setTimeout(function(){
                            location.href='<?PHP echo base_url()?>index.php/adelanto_pedido/index';    
                        },500);
