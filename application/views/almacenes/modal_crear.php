      ...
      <div class="modal-body">
       <form>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                    <label for="direccion">Ver dirección en comprobantes.</label>
                    <?php 
                    $checked = ($almacen->ver_direccion_comprobante == 1) ? 'checked' : '';
                    ?>
                    <input <?php echo $checked;?> type="checkbox" id="ver_direccion_comprobante"/>
            </div>            
        </div> 
        <?php //}?>        
       	<div class="row">
