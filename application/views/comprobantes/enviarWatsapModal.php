  ...
  <div class="modal-dialog  modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" id="cli_razon_social" name="cli_razon_social" value="<?= $comprobante['cli_razon_social']?>">
          <div class="col-xs-12 col-md-12 col-lg-12">
            <label>Numero
              <input class="form-control" type="number" name="telefono_movil" id="telefono_movil" value="<?= $comprobante['cliente_telefono_movil'];?>">              
            </label>
          </div>
	       </div>        
        </form>
...
$(document).ready(function(){
  ...
  $(document).on("click",".enviarWatsap",function(){    
    ...
    var url_pdf = '%0AFORMATO%20A4%20:<?= base_url()?>'+'index.php/download/downloadPdf/'+comprobante_id;
    var url_pdfTicket = '%0AFORMATO%20TICKET%20:<?= base_url()?>'+'index.php/download/downloadPdfTicket/'+comprobante_id;    
    $.ajax({
      url: '<?= base_url()?>index.php/comprobantes/enviarWatsapModal_g',
      method: 'POST',
      dataType: 'JSON',
