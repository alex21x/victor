                ...
                <div class="panel panel-info" >  
                    ...
                    <div class="form-group" id="valida">
                        <div class="col-lg-12">                                                    
                            ...
                            <button type="button" id="agrega_sin" onclick="agregar_fila_sin_stock()" class="btn btn-primary btn-sm">Agregar Servicio</button>
                        </div>
                    </div> 
...
<script type="text/javascript"> 
    ...
    $("#guardar").click(function(e){
        ...
        $.ajax({
            method:'post',
            url:"<?PHP echo base_url()?>/index.php/comprobantes_orden_compras/modificar_comprobante/<?PHP echo $comprobante['comprobante_id'];?>",
