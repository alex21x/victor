  ...
  <div class="modal-dialog  modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" id="cli_razon_social" name="cli_razon_social" value="<?= $nota->razon_social?>">
          <div class="col-xs-12 col-md-12 col-lg-12">
            <label>Numero
              <input class="form-control" type="number" name="telefono_movil" id="telefono_movil" value="<?= $nota->telefono_movil_1;?>">
            </label>
          </div>
	       </div>        
        </form>
...
$(document).ready(function(){
  ...
  $(document).on("click",".enviarWatsap",function(){    
    ...
    var url_pdf = '%0AFORMATO%20A4%20:<?= base_url()?>'+'index.php/download/downloadPdf_nv/'+notap_id;
    var url_pdfTicket = '%0AFORMATO%20TICKET%20:<?= base_url()?>'+'index.php/download/downloadPdfTicket_nv/'+notap_id;    
    $.ajax({
      url: '<?= base_url()?>index.php/notas/modal_envio_whatsap_g',
      method: 'POST',
      dataType: 'JSON',
      ...
      success: function(response) {
          if(response.status == -1){
            ...
            setTimeout(function() {
              ...
              a.href="https://api.whatsapp.com/send?phone=51"+telefono_movil+"&text=Gracias por tu Compra "+cli_razon_social+", desde los siguientes enlaces puedes descargar tu comprobante   "+url_pdf+" "+url_pdfTicket;
              a.target = '_blank';
