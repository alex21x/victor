...
$(document).ready(function(){
	$("#cliente").autocomplete({
		...
		source: '<?= base_url()?>index.php/proveedores/buscador_proveedor',
		minLength: 2,
	...
	$(document).on("click",".btn_regPago",function(){
		...
		$("#myModal").load("<?= base_url()?>index.php/pagos/modal_crear/",{comprobante_id: comprobante_id,cliente_id: cliente_id,vendedor_id: vendedor_id,moneda: moneda,saldo: saldo,tipoComprobante:tipoComprobante,serNum:serNum,totalCredito:totalCredito});
	});
	...
	$('#exportar_repo').click(function() {
        ...
        var url ='<?PHP echo base_url() ?>index.php/pagos/exportarExcel?'+datos+'&vendedorText='+vendedorText;
