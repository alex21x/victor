        ...
        function agregarFila(prod_id,prod_nombre,prod_precio){
            var fila = '<tr class="cont-itemOtros" >';                               
                fila += '<td class="col-sm-4" style="border:0;">'+                        
                        '<input class="form-control descripcion-itemOtros" rows="2" id="descripcionOtros" name="descripcionOtros[]" required="" value="'+prod_nombre+'">'+                        
                        '<div id="data_itemOtros"><input type="hidden" name="itemOtros_id[]" id="itemOtros_id" value="'+ prod_id+'"></div></td>';
                
                fila += '<td style="border:0;">'+
                        '<input type="number" id="cantidadOtros" name="cantidadOtros[]"  class="form-control cantidad" value="1" ></td>';
                fila += '<td style="border:0;">'+
                        '<input type="text" id="observacionOtros" name="observacionOtros[]"  class="form-control observacion" ></td>';
                fila += '<td class="eliminarFilaOtros" style="border:0;">'+
                        '<span class="glyphicon glyphicon-remove" style="color:#F44336;font-size:20px;cursor:pointer;"></span></td>';
                fila += '</tr>';
            $("#tableProductoOtros").css("display","block");
