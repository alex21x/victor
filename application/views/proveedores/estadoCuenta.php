...
<div class="container">
	...
	<h2>ESTADO DE CUENTA POR PROVEEDOR</h2>
...
<script type="text/javascript">
	...
	function estadoCuenta(){
		$.ajax({
		url: '<?= base_url()?>index.php/pagos/estadoCuenta_g',
		method: 'POST',
	...
	$('#exportar_repo').click(function() {
        ...
        var url ='<?PHP echo base_url() ?>index.php/pagos/exportarExcel_estadoCuenta?'+datos+'&vendedorText='+vendedorText;
