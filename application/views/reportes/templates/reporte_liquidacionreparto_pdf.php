...
<table>
	<tr>
		<th></th>
		<th  width="300" style="text-align: center; background-color:#dddddd; font-size: 12px;padding: 6px">Reporte liquidacion Reparto</th>
		<th></th>
	</tr>
</table><br>
...
<table border=1 >
	<tr class="rowCabecera">
		<th width="60" class="rowCodigo">FECHA DE EMISIÓN</th>							
		<th width="60" class="rowProducto">NUMSER</th>		
		<th class="rowProducto_">CLIENTE</th>
		<th width="60" class="rowProducto_des">VENDEDOR</th>
		<th width="60" class="rowProducto_des">TIPO_PAGO</th>
		<th width="60" class="rowProducto_des">SUBTOTAL</th>
		<th width="60" class="rowProducto_des">TOTAL_IGV</th>	
		<th width="60" class="rowProducto_des">TOTAL VENTA</th>									
	</tr>
