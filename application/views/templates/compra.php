        ...
        <td style="padding:30px; !important">
                    ...
                    <td width="45%" rowspan="2" valign="bottom" style="padding-left:0">
                        <div  style="border:1px solid #aaa;border-radius:10px">
                            <table width="100%" border="0" height="220" cellpadding="6" cellspacing="0">
                                ...
                                <tr>
                                    <td align="center">
                                        <span style="font-family:Tahoma, Geneva, sans-serif; font-size:20px" text-align="center"><?php echo strtoupper($compra->comp_tipo_ingreso)?></span>
                                        <br>
                                ...
                                <tr>
                                    <td align="center">
                                         <span style="font-family:Tahoma, Geneva, sans-serif; font-size:20px" text-align="center">No.: <?php echo $compra->comp_correlativo?></span>
                                    </td>
                                </tr>
                                </tbody></table>
                        </div>
            ...
            <div class="tabla_borde" >
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    <tbody>
                    <tr>
                        <td width="60%" align="left"><strong>Proveedor:</strong>  <?php echo $compra->prov_razon_social?> </td>
                        <td width="40%" align="left"><strong>Tipo Moneda: </strong> <?php echo strtoupper($compra->moneda)?></td>
                    </tr>
                    <tr>
                        <td width="60%" align="left">
                            <strong>Fecha: </strong><?php echo $compra->comp_doc_fecha?>                          
                        </td>
                        <td width="40%" align="left"><strong>Documento: </strong><?php echo $compra->comp_doc_serie?>-<?php echo $compra->comp_doc_numero?>
                    </tr>

                    <?php if($compra->comp_tipo_ingreso=="Movimiento"){?>
                     <tr>
                        <td width="60%" align="left">
                            <strong>Movimiento: </strong><?php echo $compra->comp_mov?>                          
                        </td>
                        ...
                        <tr class="border_top">
                           ...
                           <!-- codigo
                            ...
                            <td align="center" width="300px">
                                <span><?php echo $item->compd_descripcion?></span><br>
                            </td>
                            <td align="center">
                            	<?php echo $compra->simbolo?> <?php echo $item->compd_precio_unitario?>
                            </td>
                            <td align="center">
                            	<?php echo $compra->simbolo?> <?php echo $item->compd_descuento?>
                            </td>                            
                            <td align="center">
                            	<?php echo $compra->simbolo?> <?php echo $item->compd_subtotal?>
                            </td>
                        </tr>
                   		<?php endforeach?>
                ...
                <tbody><tr>
                    ...
                    <td width="50%" valign="top">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-valores-totales">
                        	...
                        	<?php if($compra->comp_doc_subtotal > 0):?>
                            <tr class="border_bottom">
                                <td align="right"><strong>Op. Gravadas:</strong></td>
                                <td width="120" align="right"><span><?php echo $compra->simbolo?> <?php echo $compra->comp_doc_subtotal?></span></td>
                            </tr>
                            <?php endif?>
                            ...
                            <?php if($compra->comp_doc_igv > 0):?>
                            <tr>
                                <td align="right"><strong>IGV:</strong></td>
                                <td width="120" align="right"><span><?php echo $compra->simbolo?> <?php echo $compra->comp_doc_igv?></span></td>
                            </tr>
                            <?php endif?>
                            ...
                            <tr>
                                ...
                                <td width="120" align="right"><span><?php echo $compra->simbolo?> <?php echo $compra->comp_doc_total?></span></td>
                            </tr>
                            </tbody>
                        </table>
                    </td>
