 ...
 ?>
        ...
        <span id="height-container">
            <p class ="datos_titulo1 cabecera">
                ...
                Profesional : <?php echo $profesional->prof_nombre; ?><br>
                Especialidad : <?php echo $especialidad->esp_descripcion; ?><br>
                --------------------------------------------------------------<br></p>
            ...
            <table width="100%">
                <thead>
                    <tr>                    
                        ...
                        <th width="10" align="center" class="tabla_cabecera">OBSERV.</th>                        
                    </tr>
                </thead>
                <tbody>
                    <?php                    
                     $i = 0;foreach($descripcionOtros as $item){?>                
                    <tr>
                        <td class="tabla_datos_cantidad"><?php echo $cantidadOtros[$i]?></td>
                        <td class="tabla_cabecera"><?php echo substr($descripcionOtros[$i],0,strrpos($descripcionOtros[$i], "/"));?></td>
                        <td class="tabla_datos_cantidad"><?php echo $observacionOtros[$i]?></td>                        
                    </tr>
                    <?php $i++;}?>                    
                </tbody>
            </table>
                ...
                <tr>
                    ...
                    <td colspan="2">                        
                        ...
                        <div id="images_gallery">
                          ...
                          <img class="historia" src="<?php echo 'images/profesional/firma/'.$profesional->prof_firma;?>">
