            ...
            <div class="tabla_borde" >
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td width="60%" align="left"><strong>Usuario : </strong> <?php echo $this->session->userdata('usuario'). " ". $this->session->userdata('apellido_paterno'); ?></td>    
                    </tr>                                        
                    <tr>
                ...
                <table width="100%" border="0" cellpadding="7" cellspacing="0">
                    <tbody>
                        <tr>
                            ...
                            <td align="center" class="bold" style="border-left: 2px solid #aaa;">Almacén</td>
