...
<head>
    ...
    tr.border_bottom td{border-bottom:1px solid red}  
...
<table width="100%" border="0">
    <tbody><tr>
        <td>
            <table width="100%" height="220px" border="0" aling="center" cellpadding="0" cellspacing="0" >
                <tbody>
                    ...
                    <td width="54%"  align="left" >
                        ...
                        <span><img src="<?PHP echo base_url();?>images/<?php echo $empresa->foto;?>" height="160" width="380" style="text-align:center;" ><br>
                    ...
                    <td width="44%"  valign="bottom" style="padding-left:0;">
                        <div  style="border:2px solid #aaa;border-radius:10px;height: 200px">
            ...
            <div>
                <hr style="display: block; height: 1px; border: 0; border-top: 1px solid #666; margin: 15px 0; padding: 0;">
