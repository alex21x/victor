            ...
            <table width="100%" height="220px" border="0" aling="center" cellpadding="0" cellspacing="0" >
                <tbody>
                    ...
                    <td width="45%" rowspan="2" valign="bottom" style="padding-left:0">
                        <div  style="border:2px solid #aaa;border-radius:10px">
                ...
                <table width="100%" border="0" cellpadding="7" cellspacing="0">
                    <tbody>
                        ...
                        <tr class="border_top">
                            ...
                            <td align="center" width="100px" style="border-left: 2px solid #aaa;">
                                <?php echo $item->medida_codigo_unidad?>
                            </td>
                         <!--<td align="center" >
                                <span><?php echo $item->prod_codigo?></span><br>
                            </td>-->
                            <td align="left" width="300px" style="border-left: 2px solid #aaa;">
                              
                                <?php $lineas = count(explode("\n", $item->descripcion));?>
                                <textarea style="width: 100%;border:0;overflow: hidden;color:#5F6A6A;" rows="<?php echo $lineas;?>"><?php echo $item->descripcion?></textarea>
                            </td>
                            <td align="center" width="100px" style="border-left: 2px solid #aaa;">
